...
<div class="container" style="margin-top: 60px; margin-bottom: 80px;">
    <div style="max-width: 500px; margin: 0 auto;">
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <p style="color: #495057;">Start your journey with premium wellness products.</p>
        </div>
            ...
            <form action="{{ route('register') }}" method="POST" id="registrationForm">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="sponsor_id" id="sponsor_id" value="{{ old('sponsor_id') }}" placeholder="Enter Sponsor Member ID" 
                        style="width: 100%; padding: 12px; border: 1px solid #dee2e6; border-radius: 8px; font-size: 16px; outline: none; transition: border-color 0.2s;"
                        required>
                    @error('sponsor_id')
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Enter your full name" 
                        style="width: 100%; padding: 12px; border: 1px solid #dee2e6; border-radius: 8px; font-size: 16px; outline: none;"
                        required>
                    @error('name')
                        <div style="color: #e63946; font-size: 13px; margin-top: 5px;">{{ $message }}</div>
                    @enderror
        ...
        <div style="text-align: center; margin-top: 30px;">
            <p style="color: #495057; font-size: 14px;">By registering, you agree to our Terms & Conditions.</p>
            <a href="{{ route('home') }}" style="color: #06B6D4; text-decoration: none; font-weight: 600;">← Back to Home</a>
        </div>
    </div>
</div>
@endsection
