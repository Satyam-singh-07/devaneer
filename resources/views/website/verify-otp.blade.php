...
<div class="container" style="margin-top: 80px; margin-bottom: 100px;">
    <div style="max-width: 400px; margin: 0 auto;">
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <p style="color: var(--text-muted);">Enter the 6-digit code sent to +91 {{ $phone }}</p>
        </div>
        ...
        <div class="income-card" style="padding: 30px; background: #ffffff; border: 1px solid #dee2e6;">
            <form action="{{ route('member.verify.otp') }}" method="POST">
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <input type="text" name="otp" id="otp" placeholder="6-digit code" 
                        style="width: 100%; padding: 12px; border: 1px solid #dee2e6; border-radius: 8px; font-size: 18px; text-align: center; letter-spacing: 5px; outline: none; background: #f8fafc; color: #0B1C2C;"
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="{{ route('member.login') }}" style="color: var(--text-muted); font-size: 14px; text-decoration: none;">Change phone number?</a>
            </div>
        </div>
    </div>
</div>
